							...
							<form action="{{ route('admin.products.store') }}" method="post" enctype="multipart/form-data" class="form-horizontal">
								...
								<div class="row form-group">
									...
									<div class="col-12 col-md-9">
										<input type="text" id="text-input" name="product_name" placeholder="Product Name" class="form-control">
								...
								<div class="row form-group">
									...
									<div class="col-12 col-md-9">
										<textarea id="textarea-input" rows="9" placeholder="Description..." class="form-control" name="product_description"></textarea>
									</div>
								</div>
								<div class="row form-group">
									<div class="col col-md-3">
